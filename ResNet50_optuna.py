...
def objective(trial):
    ...
    # Load your model
    base_model_res = tf.keras.applications.ResNet50(weights='imagenet', include_top=False, input_shape=image_shape)
    ...
    res50_output = base_model_res(input_layer, training=True)

    # Apply GlobalAveragePooling2D
    x = layers.GlobalAveragePooling2D()(res50_output)
